...
object PermissionSerializer : ModelSerializer<Permission, Permission>
{
	...
	override val modelId: UUID
		get() = UUID.fromString("c2fa697b-c8fc-4989-9319-3e027a3d7d39")
	override val dataClass: Class<Permission>
		get() = Permission::class.java
	
	override fun serialize(stream: OutputStream, schema: Schema, entity: Permission)
	{
	...
	override fun deserialize(stream: InputStream, schema: Schema): Permission
	{
