package me.wietlol.wietbot.commands.evaljavascript.core.setup
...
import me.wietlol.wietbot.commands.evaljavascript.core.services.NashornScriptEvaluator
...
object DependencyInjection
{
	...
	private fun buildMainModule(): Module =
		module {
			...
			single<ScriptEvaluator> { NashornScriptEvaluator() }
		}
